...
function calculate(opera, FirstValue, numbers) {             //ฟังก์ชั่น calculate รับพารามิตเตอร์ opera, FirstValue, numbers 
  ...
  function sum(n1, n2) {                                     //ฟังก์ชัน sum รับค่าพารามิตเตอร์เป็น n1 กับ n2 คืนค่า n1 + n2
    return n1 + n2;                                          
  }
  function multiply(n1, n2) {                                //ฟังก์ชัน multiply รับค่าพารามิตเตอร์เป็น n1 กับ n2 คืนค่า n1 * n2
    return n1 * n2;                                          
  }
  function minus(n1, n2) {                                   //ฟังก์ชัน minus รับค่าพารามิตเตอร์เป็น n1 กับ n2 คืนค่า n1 - n2  
    return n1 - n2;                                          
  }
  function devine(n1, n2) {                                 //ฟังก์ชัน devine รับค่าพารามิตเตอร์เป็น n1 กับ n2 คืนค่า n1 / n2
    return n1 / n2;                                         
  }
